...
const ADMIN_SEARCHES = [
  ...
  },
  {
    ...
    description: 'Pool completo de perfiles Data: Data Engineers (57), Data Analysts (7), Data Scientists (3), Data Architects (4) y más — ordenados por experiencia e inglés',
    ids: [13166,11670,13424,13583,13577,13167,13423,11744,12000,12406,11680,11695,12003,11674,11736,11734,11681,11676,11693,11703,11743,11677,11698,11733,11702,12001,14362,13581,11688,11678,11691,11672,13425,14366,13430,11684,13578,13427,11742,13404,11682,11737,11735,12002,11697,11701,11675,11741,13399,11708,11686,11679,13168,13426,13582,11685,11692,11699,11700,11738,11683,11673,13590,11710,11740,11739,13580,11709,11687,13403,13401,13405,13400,13402,13432,13429,11689,11690,11694,12674,13564,11696,13406,13565,13579,13431,13407,12160,14569,11671,13428,14595,14597,13422],
    createdAt: '2026-08-28T14:00:00.000Z',
  },
  {
    label: 'Principal Consulting Architect / Transformation Advisory',
    description: '~40% match · Architects, Senior PMs y Consultants con 20-27 años de experiencia en IT/SAP/enterprise — perfil de advisory y transformación multinacional',
